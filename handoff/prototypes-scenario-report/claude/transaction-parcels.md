...
<div class="noria-report-panel__workspace">
  ...
  <div class="noria-report-panel__split is-hybrid" data-view="hybrid">
    <div class="noria-report-panel__pane noria-report-panel__pane--grid">
      <div
        class="noria-data-grid noria-data-grid--bare"
        data-grid-id="report-parcels"
        data-download="transaction-parcels.csv"
        style="height: 100%"
      >
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <!--AG-GRID-BODY-->
                    <div
                      class="ag-root ag-unselectable ag-layout-normal ag-body-horizontal-content-no-gap ag-body-horizontal-scroll"
                      role="presentation"
                      style="
                    ...
                    >
                      <div
                        ...
                        aria-colcount="9"
                        aria-rowcount="6"
                        style="--ag-internal-fw-anchor-width: 458px"
                      >
                        <div
                          ...
                          >
                            ...
                            >
                              <div
                                ...
                                tabindex="0"
                                aria-rowindex="1"
                                style="top: 0px; height: 48px; width: 910px"
                              >
                                <div
        ...
        <script type="application/json" data-role="rows">
          [
            ...
            },
            {
              ...
              "apn": "1013140000300",
              "district": "Three Sisters",
              "buyer": "Central Oregon",
              "seller": "Three Sisters",
              "volume": 80,
              "price": 120,
              "sellingPOD": "N/A",
              "buyingPOD": "N/A",
    ...
    <div class="noria-report-panel__pane noria-report-panel__pane--map">
      <div class="noria-report-map">
        ...
        >
          ...
          >
            <div class="leaflet-pane leaflet-tile-pane">
              <div class="leaflet-layer" style="z-index: 1; opacity: 1">
                <div
                  ...
                  style="z-index: 19; transform: translate3d(248px, 138px, 0px) scale(1)"
                >
                  <img
                    alt=""
                  ...
                  /><img
                    alt=""
                    src="https://server.arcgisonline.com/ArcGIS/rest/services/World_Topo_Map/MapServer/tile/9/185/82"
                    class="leaflet-tile leaflet-tile-loaded"
                    style="
                      width: 256px;
                      height: 256px;
                      transform: translate3d(-430px, -18px, 0px);
                      opacity: 1;
                    "
                  /><img
                    alt=""
                  ...
                  /><img
                    alt=""
                    src="https://server.arcgisonline.com/ArcGIS/rest/services/World_Topo_Map/MapServer/tile/9/184/82"
                    class="leaflet-tile leaflet-tile-loaded"
                    style="
                      width: 256px;
                      height: 256px;
                      transform: translate3d(-430px, -274px, 0px);
                      opacity: 1;
                    "
                  /><img
                    alt=""
                    src="https://server.arcgisonline.com/ArcGIS/rest/services/World_Topo_Map/MapServer/tile/9/186/82"
                    class="leaflet-tile leaflet-tile-loaded"
                    style="
                      width: 256px;
                      height: 256px;
                      transform: translate3d(-430px, 238px, 0px);
                      opacity: 1;
                    "
                  /><img
                    alt=""
              ...
              >
                <g>
                  <path
                    ...
                    fill-opacity="0.55"
                    fill-rule="evenodd"
                    d="M246,106a6,6 0 1,0 12,0 a6,6 0 1,0 -12,0 "
                  ></path>
                  <path
                    class="leaflet-interactive"
                    stroke="#859b44"
                    ...
                    fill-opacity="0.55"
                    fill-rule="evenodd"
                    d="M199,365a6,6 0 1,0 12,0 a6,6 0 1,0 -12,0 "
                  ></path>
                  <path
                    class="leaflet-interactive"
                    stroke="#235069"
                  ...
                  <path
                    ...
                    fill-opacity="0.55"
                    fill-rule="evenodd"
                    d="M205,374a6,6 0 1,0 12,0 a6,6 0 1,0 -12,0 "
                  ></path>
                  <path
                    class="leaflet-interactive"
                    stroke="#859b44"
                    ...
                    fill-opacity="0.55"
                    fill-rule="evenodd"
                    d="M230,278a6,6 0 1,0 12,0 a6,6 0 1,0 -12,0 "
                  ></path>
                </g>
              </svg>
            </div>
            ...
            <div
              ...
              style="transform: translate3d(21403px, 47480px, 0px) scale(256)"
            ></div>
          </div>
        ...
        <script id="report-parcels-map-data" type="application/json">
          [
            {
              "lat": 44.618,
              "lng": -121.151,
...
.noria-report-panel__filters,.noria-report-panel__balance,.noria-report-panel__workspace{flex:0 0 auto}
.noria-report-panel__workspace{display:flex;flex-direction:column;gap:var(--spacing-300, 12px)}
.noria-report-panel__subtitle{margin:0}
.noria-report-panel__toolbar{display:grid;grid-template-columns:1fr auto 1fr;align-items:center;gap:var(--spacing-300, 12px);padding:var(--spacing-300, 12px) var(--spacing-400, 16px);background:var(--color-gray-50, #fafafa);border:1px solid var(--color-border, #e5e5e5);border-radius:var(--radius-200, 8px)}
.noria-report-panel__search{inline-size:min(320px,60vw)}
.noria-report-panel__split{height:clamp(28rem,60vh,40rem);display:grid;gap:var(--spacing-400);grid-template-columns:1fr 1fr;position:relative;z-index:1}
.noria-report-panel__pane{display:flex;min-width:0;min-height:0;overflow:hidden;border:1px solid var(--color-border);border-radius:var(--radius-100);background:var(--color-surface)}
.noria-report-panel__pane>*{flex:1;min-width:0}
.noria-report-map{position:relative;isolation:isolate;width:100%;height:100%;min-height:480px}
.noria-report-map__legend{position:absolute;top:var(--spacing-200);right:var(--spacing-200);z-index:800;display:flex;flex-direction:column;gap:var(--spacing-100);padding:var(--spacing-150) var(--spacing-250);background:var(--color-surface);border:1px solid var(--color-border);border-radius:var(--radius-100);box-shadow:var(--shadow-100, 0 2px 12px 0 rgba(0, 0, 0, .04))}
.noria-report-map__key{display:inline-flex;align-items:center;gap:var(--spacing-200);color:var(--color-text-primary)}
.noria-report-map__swatch{inline-size:12px;block-size:12px;border-radius:var(--radius-full);flex:none}
.noria-report-map__swatch[data-side=sending]{background:var(--color-primary)}
.noria-report-map__swatch[data-side=receiving]{background:var(--noria-green-500)}
...
.noria-data-grid--bare{border:0;border-radius:0}
