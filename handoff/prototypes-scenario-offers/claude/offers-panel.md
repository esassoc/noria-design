...
<section class="noria-offers-panel">
  <div class="repel">
    ...
    <div class="cluster" data-gap="sm">
      <esa-dropdown-menu
        ...
        data-offer-mode="buy"
        position="below-end"
        items='[{"label":"North Unit","action":"1"},{"label":"Central Oregon","action":"2"},{"label":"Three Sisters","action":"3"}]'
        width="auto"
      >
        <span
        ...
        >
          <button class="esa-button__native" type="button">
            <span class="esa-button__label"> Make an Offer to Buy + </span>
          </button>
        </span>
      </esa-dropdown-menu>
      <esa-dropdown-menu
      ...
      >
        ...
        >
          <button class="esa-button__native" type="button">
            <span class="esa-button__label"> Make an Offer to Sell + </span>
          </button>
        </span>
      </esa-dropdown-menu>
    </div>
    ...
    >
      ...
      <div class="noria-data-grid__toolbar repel">
        <div class="noria-data-grid__search">
          <esa-text-field placeholder="Search offers…" size="sm"></esa-text-field>
        </div>
        <button
                        ...
                        >
                          ...
                          >
                            <div
                              ...
                              tabindex="0"
                              aria-rowindex="1"
                              style="top: 0px; height: 48px; width: 1242px"
                            >
                              <div
                            ...
                            >
                              ...
                              >
                                ...
                                <div
                                  ...
                                  style="left: 242px; width: 120px"
                                >
                                  <span class="noria-grid-badge noria-grid-badge--info"
                                    >Open</span
                                  >
                                </div>
                                <div
        ...
        [
          {
            ...
            "type": "Buy",
            "party": { "name": "North Unit", "colorHex": "#7d4fa3" },
            "waterType": "—",
            "volume": 100,
            "price": 80,
            "created": "05/28/2026",
          ...
          },
          {
            ...
            "type": "Sell",
            "party": { "name": "Three Sisters", "colorHex": "#e07e2f" },
          ...
          },
          {
            ...
            "status": { "label": "Open", "variant": "info" },
            "type": "Buy",
            "party": { "name": "Central Oregon", "colorHex": "#2e3a66" },
            "waterType": "—",
            "volume": 200,
            "price": 115,
            "created": "05/30/2026",
      ...
      <div class="noria-data-grid__footer repel">
        ...
        <div class="cluster" data-gap="md">
          <span class="noria-data-grid__total type-body-small">Total Records: 8</span>
  ...
  <script
    type="module"
    src="/noria-design/_astro/noria-offer-dialog.astro_astro_type_script_index_0_lang.mqm5AXxZ.js"
  ></script>
...
.type-label{font-size:var(--type-size-100);font-weight:var(--font-weight-medium);line-height:var(--line-height-normal);letter-spacing:var(--letter-spacing-normal)}
...
.noria-offers-panel{display:flex;flex-direction:column;gap:var(--spacing-400, 16px);padding-block-start:var(--spacing-400, 16px)}
...
.noria-offer-dialog__adorn{display:flex;align-items:center;gap:var(--spacing-200)}
.noria-offer-dialog__affix{flex:none;color:var(--color-text-secondary);white-space:nowrap}
.noria-offer-dialog__field{flex:1;min-inline-size:0}
.noria-offer-dialog__computed{background:var(--color-primary-subtle);border:1px solid var(--color-primary-border);border-radius:var(--radius-100);padding:var(--spacing-300) var(--spacing-400)}
.noria-offer-dialog__computed-label{font-weight:var(--font-weight-semibold)}
...
.noria-data-grid .noria-grid-badge--info{color:var(--color-info-strong, #1d4ed8);border-color:var(--color-info-border, #bfdbfe);background:var(--color-info-subtle, #eff6ff)}
```
...
- `--color-info-border`: #bfdbfe _(semantic)_
- `--color-info-strong`: #1d4ed8 _(semantic)_
- `--color-info-subtle`: #eff6ff _(semantic)_
