...
<section class="noria-transactions-panel">
    ...
    <span id="tx-create-btn">
      ...
      >
        <button class="esa-button__native" type="button">
          <span class="esa-button__label"> Create Transaction + </span>
        </button>
      </span>
    </span>
  </div>
  <div class="noria-transactions-panel__grid">
    <div
      ...
      data-grid-id="transactions"
      data-download="transactions.csv"
    ...
    >
      ...
      <div class="noria-data-grid__toolbar repel">
        <div class="noria-data-grid__search">
          <esa-text-field placeholder="Search transactions…" size="sm"></esa-text-field>
        </div>
        <button
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <!--AG-GRID-BODY-->
                  <div
                    class="ag-root ag-unselectable ag-layout-auto-height ag-body-horizontal-content-no-gap ag-body-horizontal-scroll ag-body-vertical-content-no-gap"
                    role="presentation"
                    style="
                        ...
                        >
                          ...
                          >
                            <div
                              ...
                              tabindex="0"
                              aria-rowindex="1"
                              style="top: 0px; height: 48px; width: 1482px"
                            >
                              <div
                              ...
                              >
                                ...
                                <div
                                  class="ag-header-cell ag-header-parent-hidden ag-header-cell-sortable ag-right-aligned-header ag-focus-managed"
                                  role="columnheader"
                                  col-id="volume"
                                  aria-colindex="7"
                                  tabindex="-1"
                            ...
                            >
                              ...
                              >
                                ...
                                <div
                                  ...
                                  tabindex="-1"
                                  aria-colindex="3"
                                  style="left: 272px; width: 130px"
                                >
                                  <span
                                    class="noria-grid-badge noria-grid-badge--secondary"
                                    >Closed</span
                                  >
                                </div>
                                <div
                                  ...
                                  tabindex="-1"
                                  aria-colindex="4"
                                  style="left: 402px; width: 150px"
                                >
                                  <span class="noria-grid-party"
                                    ><span
                                      class="noria-grid-party__dot"
                                      style="background: rgb(46, 58, 102)"
                                    ></span
                                    ><span class="noria-grid-party__name"
                                      >Central Oregon</span
                                    ></span
                                  >
                                </div>
                                <div
                                  ...
                                  tabindex="-1"
                                  aria-colindex="5"
                                  style="left: 552px; width: 150px"
                                >
                                  <span class="noria-grid-party"
                                    ><span
                                      class="noria-grid-party__dot"
                                      style="background: rgb(125, 79, 163)"
                                    ></span
                                    ><span class="noria-grid-party__name"
                                      >North Unit</span
                                    ></span
                                ...
                                <div
                                  ...
                                  comp-id="52"
                                  col-id="volume"
                                  class="ag-cell-value ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-right-aligned-cell"
                                  tabindex="-1"
                                  aria-colindex="7"
                                  style="left: 852px; width: 150px"
                                >
                                  100.00
                                </div>
                                <div
                            ...
                            >
                              ...
                              >
                                ...
                                <div
                                  ...
                                  style="left: 272px; width: 130px"
                                >
                                  <span class="noria-grid-badge noria-grid-badge--danger"
                                    >Rejected</span
                                  >
                                </div>
                                <div
                            ...
                            >
                              ...
                              >
                                ...
                                <div
                                  ...
                                  style="left: 272px; width: 130px"
                                >
                                  <span class="noria-grid-badge noria-grid-badge--success"
                                    >Approved</span
                                  >
                                </div>
                                <div
                                ...
                                >
                                  <span class="noria-grid-party"
                                    ><span
                                      class="noria-grid-party__dot"
                                      style="background: rgb(224, 126, 47)"
                                    ></span
                                    ><span class="noria-grid-party__name"
                                      >Three Sisters</span
                                    ></span
                            ...
                            >
                              ...
                              >
                                ...
                                <div
                                  ...
                                  style="left: 272px; width: 130px"
                                >
                                  <span class="noria-grid-badge noria-grid-badge--warning"
                                    >Pending</span
                                  >
                                </div>
                                <div
      ...
      <script type="application/json" data-role="cols">
        [
          ...
          {
            "field": "sendingParcels",
            "header": "Sending Parcels",
            "minWidth": 160,
            "flex": 1
          },
          {
            "field": "receivingParcels",
            "header": "Receiving Parcels",
            "minWidth": 160,
            "flex": 1
          }
        ]
        ...
        [
          {
            ...
            "status": { "label": "Closed", "variant": "secondary" },
            "buyer": { "name": "Central Oregon", "colorHex": "#2e3a66" },
            "seller": { "name": "North Unit", "colorHex": "#7d4fa3" },
            "waterType": "Fallowed Water",
            "volume": 100,
            "price": 85,
            "sendingParcels": "0913270000100",
            "receivingParcels": "1313210000700"
          },
          {
            "id": 2,
            "actions": [
            ...
            "status": { "label": "Rejected", "variant": "danger" },
            "buyer": { "name": "North Unit", "colorHex": "#7d4fa3" },
            "seller": { "name": "Central Oregon", "colorHex": "#2e3a66" },
            "waterType": "Fallowed Water",
            "volume": 150,
            "price": 100,
            "sendingParcels": "1313210000600",
            "receivingParcels": "0914320000400"
          },
          {
            "id": 3,
            "actions": [
            ...
            "buyer": { "name": "Three Sisters", "colorHex": "#e07e2f" },
            "seller": { "name": "North Unit", "colorHex": "#7d4fa3" },
            "waterType": "Land Conversion Water",
            "volume": 60,
            "price": 90,
            "sendingParcels": "1013110000400",
            "receivingParcels": "1013140000300"
          },
          {
            "id": 4,
            "actions": [
            ...
            "status": { "label": "Approved", "variant": "success" },
            "buyer": { "name": "Central Oregon", "colorHex": "#2e3a66" },
            "seller": { "name": "Three Sisters", "colorHex": "#e07e2f" },
            "waterType": "Fallowed Water",
            "volume": 80,
            "price": 120,
            "sendingParcels": "1013140000300, 1213190000600",
            "receivingParcels": "1213200000801"
          },
          {
            "id": 5,
            "actions": [
      ...
      <div class="noria-data-grid__footer repel">
        ...
        <div class="cluster" data-gap="md">
          <span class="noria-data-grid__total type-body-small">Total Records: 5</span>
          ...
          <ol class="wiz__steps">
            ...
            <li>
              <button type="button" class="wiz__step" data-goto="4">
                <span class="wiz__chip">4</span
                ><span class="wiz__step-label">Summary</span>
              </button>
            </li>
          </ol>
        </nav>
  ...
  <script
    type="module"
    src="/noria-design/_astro/noria-transaction-wizard.astro_astro_type_script_index_0_lang.CqxGTMzc.js"
  ></script>
  ...
  <script
    type="module"
    src="/noria-design/_astro/noria-change-status-dialog.astro_astro_type_script_index_0_lang.CrBQlSDt.js"
  ></script>
</section>
```
...
.type-body{font-size:var(--type-size-200);font-weight:var(--font-weight-regular);line-height:var(--line-height-relaxed);letter-spacing:var(--letter-spacing-normal)}
.sidebar>:last-child{flex-basis:0;flex-grow:999;min-inline-size:var(--sidebar-content-min)}
.type-body-large{font-size:var(--type-size-300);font-weight:var(--font-weight-regular);line-height:var(--line-height-relaxed);letter-spacing:var(--letter-spacing-normal)}
...
.noria-transactions-panel{display:flex;flex-direction:column;gap:var(--spacing-400, 16px);padding-block-start:var(--spacing-400, 16px)}
.noria-transactions-panel__toolbar{flex:none;align-items:center}
.noria-transaction-wizard{display:contents}
.wiz{min-height:0;block-size:62vh}
.wiz__rail{border-right:1px solid var(--color-border, #e5e5e5);padding-right:var(--spacing-400, 16px)}
.wiz__rail-title{margin:0 0 var(--spacing-300, 12px);color:var(--color-text-secondary, #525252);font-weight:var(--font-weight-semibold, 600)}
.wiz__steps{list-style:none;margin:0;padding:0;display:flex;flex-direction:column;gap:var(--spacing-100, 4px)}
.wiz__step{display:flex;align-items:center;gap:var(--spacing-250, 10px);inline-size:100%;text-align:left;padding:var(--spacing-200, 8px) var(--spacing-250, 10px);border:0;border-radius:var(--radius-100, 4px);background:transparent;color:var(--color-text-secondary, #525252);font-family:inherit;font-size:var(--type-size-200, 15px);cursor:pointer;transition:background .15s ease,color .15s ease}
.wiz__step[aria-current=step]{background:var(--color-primary-subtle, #f3f8fc);color:var(--color-primary, #235069);font-weight:var(--font-weight-semibold, 600)}
.wiz__chip{flex:none;display:inline-flex;align-items:center;justify-content:center;inline-size:1.75rem;block-size:1.75rem;border-radius:var(--radius-full, 999px);border:1px solid var(--color-border-strong, #d4d4d4);background:var(--color-surface, #fff);font-size:var(--type-size-150, 13px);font-weight:var(--font-weight-semibold, 600);color:var(--color-text-secondary, #525252)}
.wiz__step[aria-current=step] .wiz__chip{background:var(--color-primary, #235069);border-color:var(--color-primary, #235069);color:#fff}
.wiz__step-label{min-width:0}
.wiz__main{min-width:0;display:flex;flex-direction:column}
.wiz__panel:not([hidden]){flex:1 1 auto;min-block-size:0;display:flex;flex-direction:column}
.wiz__group{color:var(--color-text-primary, #171717);font-weight:var(--font-weight-semibold, 600)}
.wiz__group-hint{margin:0;color:var(--color-text-secondary, #525252)}
.wiz__computed{display:flex;flex-direction:column;gap:var(--spacing-200, 8px);background:var(--color-primary-subtle, #f3f8fc);border:1px solid var(--color-primary-border, #c9e1ee);border-radius:var(--radius-100, 4px);padding:var(--spacing-300, 12px) var(--spacing-400, 16px)}
.wiz__computed-label{font-weight:var(--font-weight-semibold, 600)}
.wiz__footer{align-items:center}
.wiz__footer-left{display:inline-flex}
.noria-change-status{display:contents}
...
.noria-data-grid .noria-grid-badge{display:inline-flex;align-items:center;padding:2px 8px;border:1px solid transparent;border-radius:var(--radius-100, 4px);font-size:var(--type-size-150, .875rem);font-weight:var(--font-weight-medium, 500);line-height:1.4;white-space:nowrap}
.noria-data-grid .noria-grid-badge--secondary{color:var(--color-text-secondary, #525252);border-color:var(--color-border-strong, #d4d4d4);background:var(--color-surface-sunken, #efefef)}
.noria-data-grid .noria-grid-party{display:inline-flex;align-items:center;gap:var(--spacing-200, 8px);min-width:0}
.noria-data-grid .noria-grid-party__dot{flex:none;inline-size:12px;block-size:12px;border-radius:var(--radius-full, 999px)}
.noria-data-grid .noria-grid-party__name{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
.noria-data-grid .noria-grid-badge--danger{color:var(--color-danger-strong, #b91c1c);border-color:var(--color-danger-border, #fecaca);background:var(--color-danger-subtle, #fef2f2)}
.noria-data-grid .noria-grid-badge--success{color:var(--color-success-strong, #15803d);border-color:var(--color-success-border, #bbf7d0);background:var(--color-success-subtle, #f0fdf4)}
.noria-data-grid .noria-grid-badge--warning{color:var(--color-warning-strong, #b45309);border-color:var(--color-warning-border, #fde68a);background:var(--color-warning-subtle, #fffbeb)}
...
- `--color-danger-border`: #fecaca _(semantic)_
- `--color-danger-strong`: #b91c1c _(semantic)_
- `--color-danger-subtle`: #fef2f2 _(semantic)_
...
- `--color-success-border`: #bbf7d0 _(semantic)_
- `--color-success-strong`: #15803d _(semantic)_
- `--color-success-subtle`: #f0fdf4 _(semantic)_
